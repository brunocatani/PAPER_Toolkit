...
def build(library: dict[str, Any], snapshot: dict[str, Any], reload_clip: dict[str, Any]) -> dict[str, Any]:
    ...
    profile = {
        ...
        "mappedEvents": [
            ...
            mapped_event("mag_in", "magazine_insert", "stageEnter", "sound", "Soundplay.WPN1AMRmagin", "Plays when the continuous grip changes to the 80 percent insertion segment.", stages),
            mapped_event("bolt_close", "bolt_close", "stageEnter", "sound", "Soundplay.WPN1AMRboltclose", "Plays when the continuous bolt grip changes to its recorded closing path.", stages),
