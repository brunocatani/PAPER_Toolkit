...
#include "paper_toolkit/NativeMemory.h"
...
namespace paper_toolkit::weapon_animation_preharvest
{
    namespace
    {
        /*
        ...
        [[nodiscard]] bool claimOrValidateThread(Runtime& state)
        {
            ...
            if (!state.threadMismatchLogged.exchange(
                ...
                PAPER_TOOLKIT_LOG_ERROR(Animation,
        ...
        void finishTerminal(Runtime& state, const State terminalState, const char* reason)
        {
            ...
            if (terminalState == State::Completed) {
                PAPER_TOOLKIT_LOG_INFO(Animation,
                ...
                PAPER_TOOLKIT_LOG_WARN(Animation,
            ...
            const std::uint32_t maxGroups)
        {
            ...
            if (groupCount > 0) {
                ...
                PAPER_TOOLKIT_LOG_DEBUG(Animation,
