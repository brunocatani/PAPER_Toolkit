...
namespace redux
{
    namespace
    {
        ...
        constexpr const char* kDefaultIniContent =
            ...
            "iLogLevel = 2\n"
            "\n"
            "; Trigger selects the grip type on eligible parts: grab alone = normal\n"
            "; authority grab; grab with the OFFHAND trigger held = attach-only\n"
            "; manipulation, which stays attach-only until the part is released.\n"
